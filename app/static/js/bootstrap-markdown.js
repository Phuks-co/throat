...
(function(factory) {
  ...
  var Markdown = function(element, options) {
    ...
    var opts = ['savable', 'hideable', 'width',
      ...
      for (i = 0; i < buttonsArray.length; i++) {
        ...
        for (y = 0; y < btnGroups.length; y++) {
          ...
          for (z = 0; z < buttons.length; z++) {
            ...
            buttonContainer.text(' ' + this.__localize(btnText)).addClass('btn-default btn-sm btn-editor').addClass(btnClass);
    ...
    showEditor: function() {
      ...
      if (this.$editor === null) {
        ...
        if (options.fullscreen.enable) {
          editorHeader.append('<div class="md-controls"><a tabindex="-1" class="md-control md-control-fullscreen" href="#"><span class="' + this.__getIcon(options.fullscreen.icons.fullscreenOn) + '"></span></a></div>').on('click', '.md-control-fullscreen', function(e) {
            e.preventDefault();
    ...
    buttons: [
      [{
        ...
        data: [{
          ...
          title: 'Preview',
          btnText: 'Preview',
          btnClass: 'btn btn-primary btn-sm btn-editor ',
          icon: {
