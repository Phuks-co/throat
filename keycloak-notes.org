...
#+BEGIN_SRC sh
  curl --location --request POST 'http://192.168.100.5:5080/auth/realms/master/protocol/openid-connect/token' \
...
#+BEGIN_SRC sh
  curl --location --request POST 'http://192.168.100.5:5080/auth/admin/realms/example/users' \
...
#+BEGIN_SRC python
 ...
 keycloak_admin = KeycloakAdmin(server_url="http://192.168.100.5:5080/auth/",
                               realm_name="master",
