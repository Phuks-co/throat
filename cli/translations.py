...
def genpot():
    subprocess.run("""pybabel extract \
    ...
    -k _l \
    -o app/translations/messages.pot .""", shell=True)
    print("Done.")


@translations.command(name="compile", help="Compiles the translation .po files into .mo files")
def genmo():
